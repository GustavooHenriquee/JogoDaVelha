...
<body>
		...
		<div class="col-dg-8 cor conteudo">
			<div>
				<h2>
					...
					<p></p>
					<p>Para jogar, basta fazer o login em sua conta, caso não esteja login e senha, terá que fazer o cadastro.
					<p>Após fazer o Login será lhe apresentado um tabuleiro representado por uma matriz 3 x 3, neste tabuleiro 
					você tem direito a escolher uma posição a se marcar a cada vez que se tornar a sua vez de jogar.	</p>
					<p>A vitória ocorre quando um jogador consegue colocar três símbolos em sequência, seja em linha, coluna ou 
					na diagonal principal do tabuleiro. Caso não ocorra esta possibilidade e todos os campos do tabuleiro já foi 
					preenchido ai é chamado tradicionalmente de “Velha” ou seja, ninguém venceu</p>
	...
	<div id="caixaRodape" class="col-dg-12">
		...
		<div class="col-dg-2 vazio"></div>
		<div class="col-dg-8" id="direitos">Jogo da Velha |
