	...
	<div id="caixaJogo" class="col-dg-12 ">
		...
		<div class="col-dg-8 cor conteudo">
			<div>
				...
				<p></p>
				<p>
					O Jogo da Velha é um projeto constituído por <b>Ariel
				...
				<div col-dg-4 col-dm-4 style="height:300px; border:1px solid black;">
					<p style="width:300px; border:1px solid black; margin-left: 2%;">
						Gustavo Henrique Nascimento Souza
					</p>
					<p style="width:300px; border:1px solid black;  margin-left: 2%;">
					<br>
				...
				<div col-dg-8 col-dm-8 style="height:300px; border:1px solid black;">
					<img src="xx" alt="xx" style="height:300px; width:300px; border:1px solid black">
				</div>
